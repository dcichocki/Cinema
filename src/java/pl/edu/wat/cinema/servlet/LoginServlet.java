...
//            session.createQuery("create table '"+user.getLogin()+
//                    "' ('login_id' int(10) unsigned NOT NULL auto_increment, "
//                   //         + "'seance_id' int(10) NOT NUL, "
//                            + "'title' varchar(45), PRIMARY KEY  ('login_id'))");
//            //session.createQuery("insert into '"+user.getLogin()+"' values ('tttt')");
